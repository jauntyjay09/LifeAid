...
<option value="West Bengal">
                    ...
                    <div class="form-row">
                      ...
                      <div class="col-md-6 mb-3">
                        ...
                        <input type="text" name="city" class="form-control" maxlength=120 pattern="[-,./#()*_,a-zA-Z0-9 ]+" id="validationCustom03" required>
                        <div class="invalid-feedback">
                  ...
                  <div class="col-md-6 mb-3">
                    ...
                    <input type="text" name="area" class="form-control" maxlength=120 pattern="[-,./#()*_,a-zA-Z0-9 ]+" id="validationCusto13" required>
                    <div class="invalid-feedback">
                ...
                <div class="form-row">
                  <div class="col-md-3 mb-3">
                    ...
                    <input type="text" name="pin" class="form-control"   minlength=6 maxlength=6 pattern="[0-9]+" id="validationCustom05" required>
                    <div class="invalid-feedback">
