        ...
        <div class="row col-md-10 mx-auto  ">
            <div class=" col-md-3 mx-auto alert-primary card ma">
               <div class="card-body">
                  ...
                  <h2 class="card-title text-center acc"><b><?php echo $aac; ?>%</b></h2>
              ...
              <div class=" col-md-3 mx-auto alert-success card ma">
                <div class="card-body">
                   ...
                   <h2 class="card-title text-center rcc"><b><?php echo $rrc; ?>%</b></h2>
               ...
               <div class=" col-md-3 mx-auto alert-danger card ma">
                <div class="card-body">
                   ...
                   <h2 class="card-title text-center dcc"><b><?php echo $ddc; ?>%</b></h2>
