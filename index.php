<?php 
    ...
    $ttc=$covidarray['statewise'][0]['confirmed'];
        ...
        <div class="row col-md-10 mx-auto  ">
            <div class=" col-md-3 mx-auto alert-primary card ma">
               <div class="card-body">
                  ...
                  <h2 class="card-title text-center acc"><b>80%</b></h2>
              ...
              <div class=" col-md-3 mx-auto alert-success card ma">
                <div class="card-body">
                   ...
                   <h2 class="card-title text-center rcc"><b>80%</b></h2>
               ...
               <div class=" col-md-3 mx-auto alert-danger card ma">
                <div class="card-body">
                   ...
                   <h2 class="card-title text-center dcc"><b>80%</b></h2>
                   <p class="card-text text-center">
