            ...
            <div class=" col-md-3 mx-auto alert-primary card ma">
              ...
              <div class=" col-md-3 mx-auto alert-success card ma">
                <div class="card-body">
                  ...
                  <h2 class="card-title text-center acc"><b><?php echo $rc; ?></b></h2>
                     <h3 class="card-title text-center acc"><b><?php echo $rrc; ?>%</b></h3>
                      <br>
               ...
               <div class=" col-md-3 mx-auto alert-danger card ma">
                <div class="card-body">
                   ...
                   <h2 class="card-title text-center acc"><b><?php echo $dc; ?></b></h2>
                     <h3 class="card-title text-center acc"><b><?php echo $ddc; ?>%</b></h3>
                      <br>
